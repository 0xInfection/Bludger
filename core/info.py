...
# Info about project and version
# Used for constructing the banner as well as copyright strings
...
__author__ = 'Pinaki Mondal'

__username__ = '0xInfection'

__license__ = 'GNU General Public License v3 (GPLv3)'

__homepage__ = 'https://github.com/0xInfection/Bludger'

__copyright__ = f'Copyright (c) 2021-{datetime.now().year.__str__()} @{__username__}'

__about__ =  'Bludger is a GitHub Actions Automation Framework built around the idea'
